...
@property (strong, nonatomic) IBOutlet UILabel *peizhiLabel;
@property (strong, nonatomic) IBOutlet UILabel *peizhiTitleLabel;

@property (strong, nonatomic) IBOutlet UILabel *detailTitleLabel;//车辆详情标题
