...
#import "FBPublishTucaoController.h"
...
@interface FBPublishTucaoController ()
...
@implementation FBPublishTucaoController
...
- (void)keyboardWillShow:(NSNotification*)notification{
    ...
    [UIView animateWithDuration:animationDuration animations:^{
        ...
        if (haveImage) {
            ...
            self.inputView.bottom = keyboardRect.origin.y - self.inputView.height - 10;
...
- (void)textViewDidChange:(UITextView *)textView
{
    ...
    if (textView.height <= 120 && textView.contentSize.height <= 120) {
        ...
        }else
        {
            ...
            self.inputView.bottom = current_KeyBoard_Y - self.inputView.height - 10;
