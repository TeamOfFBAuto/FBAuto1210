...
- (void)viewDidLoad
{
    ...
    //姓名
    UILabel *nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(13, 19, DEVICE_WIDTH - 26, 15)];
    nameLabel.font = [UIFont boldSystemFontOfSize:15];
    nameLabel.text = @"一族（天津）传媒科技有限公司";
    [self.view addSubview:nameLabel];
    
    //地址
    UILabel *dizhiLabel = [[UILabel alloc]initWithFrame:CGRectMake(13, CGRectGetMaxY(nameLabel.frame)+12, nameLabel.width, 15)];
    ...
    //邮编
    UILabel *youbianLabel = [[UILabel alloc]initWithFrame:CGRectMake(13, CGRectGetMaxY(dizhiLabel.frame)+12, nameLabel.width, 15)];
    youbianLabel.font = [UIFont boldSystemFontOfSize:10.5];
    youbianLabel.text = @"邮编：300457";
    [self.view addSubview:youbianLabel];
    
    //电话
    UILabel *phoneLabel = [[UILabel alloc]initWithFrame:CGRectMake(13, CGRectGetMaxY(youbianLabel.frame)+12, nameLabel.width, 15)];
    phoneLabel.font = [UIFont boldSystemFontOfSize:10.5];
    phoneLabel.text = @"电话：022 6621 6608";
    [self.view addSubview:phoneLabel];
    
    //传真
    UILabel *chuanzhenLabel = [[UILabel alloc]initWithFrame:CGRectMake(13, CGRectGetMaxY(phoneLabel.frame)+12, nameLabel.width, 15)];
    ...
    CGFloat radio = 290 / 200.f;
    
    dituImv.frame = CGRectMake(15, CGRectGetMaxY(chuanzhenLabel.frame)+22, DEVICE_WIDTH - 30, (DEVICE_WIDTH - 30) / radio);
    
//    if (iPhone5) {
//        dituImv.frame = CGRectMake(15, CGRectGetMaxY(chuanzhenLabel.frame)+22, DEVICE_WIDTH - 30, 220);
//    }else{
